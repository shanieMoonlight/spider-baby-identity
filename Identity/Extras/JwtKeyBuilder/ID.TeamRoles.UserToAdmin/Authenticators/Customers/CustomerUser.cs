...
/// <summary>
/// Only a Customer Team Regular user shall pass!
/// </summary>
public static class CustomerUserAuthenticator
{
    ...
    {
        public const string NAME = $"{nameof(CustomerUserAuthenticator)}.{nameof(Policy)}";
...
public static class CustomerUserAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddCustomerUserAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, CustomerUserAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(CustomerUserAuthenticator.Policy.NAME, policy =>
                  policy
                  .RequireAuthenticatedUser()
                  .Requirements.Add(new CustomerUserAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
