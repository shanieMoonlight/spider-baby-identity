...
public abstract record AIdUserAndTeamAwareCommand<TUser>
    : AIdUserAwareCommand<TUser>,
    IIdUserAndTeamAwareRequest<TUser>
    where TUser : AppUser
{
    /// <summary>
...
/// </summary>
/// <typeparam name="TUser">Type of AppUser</typeparam>
public abstract record AIdUserAndTeamAwareCommand<TUser, TResponse>
    : AIdUserAwareCommand<TUser, TResponse>,
    IIdUserAndTeamAwareRequest<TUser>
    where TUser : AppUser
{
    /// <summary>
