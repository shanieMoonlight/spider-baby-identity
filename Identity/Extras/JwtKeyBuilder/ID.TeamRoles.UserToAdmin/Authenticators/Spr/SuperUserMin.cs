...
/// <summary>
/// Only a Super Team User shall pass!
/// </summary>
public static class SuperUserMinimumAuthenticator    
{
    ...
    {
        public const string NAME = $"{nameof(SuperUserMinimumAuthenticator)}.{nameof(Policy)}";
...
public static class SuperUserMinimumAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddSuperUserMinimumAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, SuperUserMinimumAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(SuperUserMinimumAuthenticator.Policy.NAME, policy =>
                  policy
                  .RequireAuthenticatedUser()
                  .Requirements.Add(new SuperUserMinimumAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
