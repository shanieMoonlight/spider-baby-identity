...
public abstract class StringValueObject(string value) : ValueObject<string>(value.Trim())
{
    /// <summary>
...
public abstract class NullableStringValueObject(string? value) : ValueObject<string?>(value?.Trim())
{
    /// <summary>
    /// Determines whether this value object's value equals another string value.
    /// </summary>
