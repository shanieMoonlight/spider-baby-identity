...
//        if (tfEnabled)
//        {
//            var twoFactorResult = await HandleTwoFactor(
//                   user: user,
//                   team: team,
//                   dto.RememberMe,
...
//            return await ReturnTwoFactorCookieAsync(
//               user: user,
//               team: team,
//               dto.RememberMe,
//               currentDeviceId: dto.DeviceId);
...
//        else
//        {
//            return await ReturnStandardCookieAsync(
//                 user: user,
//                 team: team, 
//                 dto.RememberMe,
//                 currentDeviceId: dto.DeviceId);
...
//    private async Task<GenResult<MfaResultData>> HandleTwoFactor(
//        AppUser user,
//        Team team,
//        bool rememberMe,
