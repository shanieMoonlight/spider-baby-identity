...
//        tknSvc.Verify(x => x.GenerateAndStoreWithDeviceAsync(It.IsAny<AppUser>(), It.IsAny<IEnumerable<AuthMethodRef>>(), It.IsAny<TrustedDevice>(), It.IsAny<CancellationToken>()), Times.Never);
//    }
...
//        tknSvc
//            .Setup(s => s.GenerateAndStoreWithDeviceAsync(
...
//        tknSvc.Verify(s => s.GenerateAndStoreWithDeviceAsync(user, It.IsAny<IEnumerable<AuthMethodRef>>(), device, It.IsAny<CancellationToken>()), Times.Once);
//    }
//}
