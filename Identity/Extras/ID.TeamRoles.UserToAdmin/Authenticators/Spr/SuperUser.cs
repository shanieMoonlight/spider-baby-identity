...
/// <summary>
/// Only a Super Team Regular user shall pass!
/// </summary>
public static class SuperUserAuthenticator
{
    ...
    {
        public const string NAME = $"{nameof(SuperUserAuthenticator)}.{nameof(Policy)}";
...
public static class SuperUserAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddSuperUserAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, SuperUserAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(SuperUserAuthenticator.Policy.NAME, policy =>
                  policy
                  .RequireAuthenticatedUser()
                  .Requirements.Add(new SuperUserAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
