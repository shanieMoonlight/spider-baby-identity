...
public class MntcMgrTests
{
    [Fact]
    public async Task AuthHandler_IsAuthorized_ShouldReturnTrue_WhenUserIsInMntcTeamAndManagerRoleAsync()
    {
        // Arrange
        ...
        var authHandler = new MntcManagerAuthenticator.AuthHandler();
        ...
        var resourceFilter = new MntcManagerAuthenticator.ResourceFilter();

        var actionContext = ContextProvider.GetActionExecutingContext(httpContext);
        var actionFilter = new MntcManagerAuthenticator.ActionFilter();
