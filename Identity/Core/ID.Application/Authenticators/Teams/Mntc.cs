...
public static class MntcAuthenticator
{

    /// <summary>
    /// Only Mntc team members shall pass!
    /// </summary>
    ...
    public static class Policy
    {
        ...
        public class Handler(IHttpContextAccessor _httpContextAccessor) : AuthorizationHandler<Requirement>
        {
...
public static class MntcAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddMntcAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, MntcAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(MntcAuthenticator.Policy.NAME, policy =>
                  policy
                    .RequireAuthenticatedUser()
                    .Requirements.Add(new MntcAuthenticator.Policy.Requirement(null)))
        );
    }
}//Cls
