...
/// <summary>
/// Implementation of the recurring job manager that uses the Priority Queue for Hangfire integration.
...
internal class HfPriorityRecurringJobMgr(IHangfireInstanceProvider storageProvider)
    : AHfRecurringJobMgr(
        storageProvider,
        IdInfrastructureConstants.Jobs.Queues.Priority
    ),
    IHfPriorityRecurringJobMgr
{ }
