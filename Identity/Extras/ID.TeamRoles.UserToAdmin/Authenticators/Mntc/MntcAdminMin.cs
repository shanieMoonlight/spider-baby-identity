...
/// <summary>
/// Only a Super Team, Mntc Team or Mntc team at Mgr or higher shall pass!
/// </summary>
public static class MntcAdminMinimumAuthenticator
{
    /// <summary>
    /// <inheritdoc cref="MntcAdminMinimumAuthenticator"/>
    /// </summary>
    protected internal class AuthHandler : IAuthHandler
    {
        ...
        public bool IsAuthorized(HttpContext context) =>
            ...
            ||
            (context.IsInMntcTeam() && context.IsAdminMin());
    ...
    {
        public const string NAME = $"{nameof(MntcAdminMinimumAuthenticator)}.{nameof(Policy)}";
...
public static class MntcAdminMinimumAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddMntcAdminMinimumAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, MntcAdminMinimumAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(MntcAdminMinimumAuthenticator.Policy.NAME, policy =>
                  policy
                  .RequireAuthenticatedUser()
                  .Requirements.Add(new MntcAdminMinimumAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
