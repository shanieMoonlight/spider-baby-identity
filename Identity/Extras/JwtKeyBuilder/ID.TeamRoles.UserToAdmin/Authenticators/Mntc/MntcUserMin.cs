...
/// <summary>
/// Only a Super Team or Mntc team at User or higher shall pass!
/// </summary>
public static class MntcUserMinimumAuthenticator
{
    /// <summary>
    /// <inheritdoc cref="MntcUserMinimumAuthenticator"/>
    /// </summary>
    protected internal class AuthHandler : IAuthHandler
    {
        ...
        public bool IsAuthorized(HttpContext context) =>
            ...
            ||
            (context.IsInMntcTeam() && context.IsUserMin());
    }
    ...
    {
        public const string NAME = $"{nameof(MntcUserMinimumAuthenticator)}.{nameof(Policy)}";
...
public static class MntcUserMinimumAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddMntcUserMinimumAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, MntcUserMinimumAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(MntcUserMinimumAuthenticator.Policy.NAME, policy =>
                  policy
                  .RequireAuthenticatedUser()
                  .Requirements.Add(new MntcUserMinimumAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
