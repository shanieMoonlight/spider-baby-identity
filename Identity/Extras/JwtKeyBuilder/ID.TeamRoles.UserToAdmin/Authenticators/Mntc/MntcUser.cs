...
/// <summary>
/// Only a Mntc Team Regular user shall pass!
/// </summary>
public static class MntcUserAuthenticator
{
    ...
    {
        public const string NAME = $"{nameof(MntcUserAuthenticator)}.{nameof(Policy)}";
...
public static class MntcUserAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddMntcUserAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, MntcUserAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(MntcUserAuthenticator.Policy.NAME, policy =>
                  policy
                  .RequireAuthenticatedUser()
                  .Requirements.Add(new MntcUserAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
