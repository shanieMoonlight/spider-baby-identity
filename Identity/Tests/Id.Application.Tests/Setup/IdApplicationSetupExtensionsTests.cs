...
namespace ID.Application.Tests.Setup;
public class IdApplicationSetupExtensionsTests
{
    private readonly IdApplicationOptions setupOptions = new()
    {
        FromAppHeaderKey = "DefaultFromAppHeaderKey",
    ...
    public void AddIdApplication_RegistersIdUnitOfWorkPipelineBehaviour()
    {
        ...
        // Act
        services.AddMyIdApplication<AppUser>(setupOptions);

        services.FirstOrDefault(s => s.ImplementationType == typeof(IdCommandTransactionPipelineBehaviour<,>)).ShouldNotBeNull();
    ...
    public void AddIdApplication_Registers_IdValidationPipelineBehaviour()
    {
        ...
        services.FirstOrDefault(s => s.ImplementationType == typeof(IdValidationPipelineBehaviour<,>)).ShouldNotBeNull();
    ...
    public void AddIdApplication_Registers_UserAndTeamInfo_BehaviorsInCorrectOrder2(Type[] behaviourTypesInOrder)
    {
        ...
        // Act
        services = services.AddMyIdApplication<AppUser>(setupOptions);
    ...
    public void AddIdApplication_ShouldRegisterValidators()
    {
        ...
        var validatorRegistrations = services
            ...
            .Where(sd => sd.ImplementationType?.AssemblyQualifiedName != null &&  sd.ImplementationType.AssemblyQualifiedName.StartsWith("ID.Application"))
            .ToList();
