...
/// <summary>
/// Only a Mntc Team Administrator shall pass!
/// </summary>
public static class MntcAdminAuthenticator
{
    ...
    {
        public const string NAME = $"{nameof(MntcAdminAuthenticator)}.{nameof(Policy)}";
...
public static class MntcAdminAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddMntcAdminAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, MntcAdminAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(MntcAdminAuthenticator.Policy.NAME, policy =>
                  policy
                  .RequireAuthenticatedUser()
                  .Requirements.Add(new MntcAdminAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
