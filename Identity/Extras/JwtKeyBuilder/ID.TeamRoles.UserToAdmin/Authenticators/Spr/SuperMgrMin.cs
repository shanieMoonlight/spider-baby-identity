...
/// <summary>
/// Only a Super Team Manager shall pass!
/// </summary>
public static class SuperManagerMinimumAuthenticator    
{
    ...
    {
        public const string NAME = $"{nameof(SuperManagerMinimumAuthenticator)}.{nameof(Policy)}";
...
public static class SuperManagerMinimumAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddSuperManagerMinimumAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, SuperManagerMinimumAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(SuperManagerMinimumAuthenticator.Policy.NAME, policy =>
                  policy
                  .RequireAuthenticatedUser()
                  .Requirements.Add(new SuperManagerMinimumAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
