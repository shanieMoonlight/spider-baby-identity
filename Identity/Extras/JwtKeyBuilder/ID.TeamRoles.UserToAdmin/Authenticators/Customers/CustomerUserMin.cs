...
/// <summary>
/// Only a Super Team, Mntc Team or Customer team at User or higher shall pass!
/// </summary>
public static class CustomerUserMinimumAuthenticator
{
    /// <summary>
    /// <inheritdoc cref="CustomerUserMinimumAuthenticator"/>
    /// </summary>
    protected internal class AuthHandler : IAuthHandler
    {
        ...
        public bool IsAuthorized(HttpContext context) =>
            ...
            ||
            context.IsInCustomerTeam() && context.IsUserMin();
    }
    ...
    {
        public const string NAME = $"{nameof(CustomerUserMinimumAuthenticator)}.{nameof(Policy)}";
...
public static class CustomerUserMinimumAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddCustomerUserMinimumAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, CustomerUserMinimumAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(CustomerUserMinimumAuthenticator.Policy.NAME, policy =>
                  policy
                  .RequireAuthenticatedUser()
                  .Requirements.Add(new CustomerUserMinimumAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
