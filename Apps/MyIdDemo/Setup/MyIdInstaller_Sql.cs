...
/// </summary>
public class MyIdInstaller_Sql : IServiceInstaller
{
    /// <summary>
    ...
    public WebApplicationBuilder Install(WebApplicationBuilder builder, StartupData startupData)
    {
        ...
        builder.Services.AddMyId_SqlServer(
           config =>
           {
...
/// Install Identity stuff
/// </summary>
public static class MyIdInstallerSqlExtensions
{
    ...
    /// <param name="builder">Application Builder</param>
    /// <param name="startupData">All the app config and settings</param>
    public static WebApplicationBuilder InstallMyId_Sql(this WebApplicationBuilder builder, StartupData startupData) =>
        new MyIdInstaller_Sql().Install(builder, startupData);
