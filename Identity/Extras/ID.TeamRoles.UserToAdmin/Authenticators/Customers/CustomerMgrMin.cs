...
/// <summary>
/// Only a Super Team, Mntc Team or Customer team at Mgr or higher shall pass!
/// </summary>
public static class CustomerManagerMinimumAuthenticator
{
    /// <summary>
    /// <inheritdoc cref="CustomerManagerMinimumAuthenticator"/>
    /// </summary>
    protected internal class AuthHandler : IAuthHandler
    {
        ...
        public bool IsAuthorized(HttpContext context) =>
            context.IsHigherThanCustomer()
            ||
            (context.IsInCustomerTeam() && context.IsMgrMin());
    ...
    {
        public const string NAME = $"{nameof(CustomerManagerMinimumAuthenticator)}.{nameof(Policy)}";
...
public static class CustomerManagerMinimumAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddCustomerManagerMinimumAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, CustomerManagerMinimumAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(CustomerManagerMinimumAuthenticator.Policy.NAME, policy =>
                  policy
                  .RequireAuthenticatedUser()
                  .Requirements.Add(new CustomerManagerMinimumAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
