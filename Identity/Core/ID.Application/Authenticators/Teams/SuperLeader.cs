...
public static class SuperLeaderAuthenticator
{
    /// <summary>
    ...
    /// Only a CustomerLeader or Super or Super team members shall pass!
    /// </summary>
    [AttributeUsage(AttributeTargets.All)]
    ...
    {
        public const string NAME = $"{nameof(SuperLeaderAuthenticator)}.{nameof(Policy)}";
...
public static class SuperLeaderAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddSuperLeaderAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, SuperLeaderAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(SuperLeaderAuthenticator.Policy.NAME, policy =>
                  policy
                    .RequireAuthenticatedUser()
                    .Requirements.Add(new SuperLeaderAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
