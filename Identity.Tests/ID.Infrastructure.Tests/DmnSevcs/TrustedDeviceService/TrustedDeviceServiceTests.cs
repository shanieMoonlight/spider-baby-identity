...
public class TrustedDeviceServiceTests
{
    ...
    [Fact]
    public async Task AddAsync_Should_Return_BadRequest_When_Max_Exceeded()
    {
        // Arrange
        ...
        var set = new System.Collections.Generic.HashSet<TrustedDevice>();
        for (int i = 0; i < max; i++)
    ...
    public async Task RevokeById_Should_Revoke_When_Found()
    {
        ...
        var devices = new System.Collections.Generic.HashSet<TrustedDevice> { device };
