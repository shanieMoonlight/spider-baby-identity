...
/// <summary>
/// Only a Mntc Team Manager shall pass!
/// </summary>
public static class MntcManagerAuthenticator
{
    ...
    {
        public const string NAME = $"{nameof(MntcManagerAuthenticator)}.{nameof(Policy)}";
...
public static class MntcManagerAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddMntcManagerAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, MntcManagerAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(MntcManagerAuthenticator.Policy.NAME, policy =>
                  policy
                  .RequireAuthenticatedUser()
                  .Requirements.Add(new MntcManagerAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
