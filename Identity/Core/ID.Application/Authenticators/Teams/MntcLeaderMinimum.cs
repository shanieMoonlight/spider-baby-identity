...
public static class MntcLeaderMinimumAuthenticator
{
    /// <summary>
    ...
    protected internal class AuthHandler : IAuthHandler
    {
        ...
        public bool IsAuthorized(HttpContext context)
        {
            ...
            var isHigherThanCurrentUserTeam = context.User.IsInSuperTeam();

            return isHigherThanCurrentUserTeam || isInMntcTeam && isLeader;
        }
    }//Cls
    ...
    {
        public const string NAME = $"{nameof(MntcLeaderMinimumAuthenticator)}.{nameof(Policy)}";
...
public static class MntcLeaderMinimumAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddMntcLeaderMinimumAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, MntcLeaderMinimumAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(MntcLeaderMinimumAuthenticator.Policy.NAME, policy =>
                  policy
                    .RequireAuthenticatedUser()
                    .Requirements.Add(new MntcLeaderMinimumAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
