...
public class MntcAdminTests
{
    [Fact]
    public async Task AuthHandler_IsAuthorized_ShouldReturnTrue_WhenUserIsInMntcTeamAndAdminRoleAsync()
    {
        // Arrange
        ...
        var authHandler = new MntcAdminAuthenticator.AuthHandler();
        ...
        var resourceFilter = new MntcAdminAuthenticator.ResourceFilter();

        var actionContext = ContextProvider.GetActionExecutingContext(httpContext);
        var actionFilter = new MntcAdminAuthenticator.ActionFilter();
