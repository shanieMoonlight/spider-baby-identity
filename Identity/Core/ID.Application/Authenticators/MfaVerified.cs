...
public static class MfaVerifiedAuthenticator
{
    /// <summary>
    ...
    {
        public const string NAME = $"{nameof(MfaVerifiedAuthenticator)}.{nameof(Policy)}";
...
public static class MfaVerifiedAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddMfaVerifiedAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, MfaVerifiedAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(MfaVerifiedAuthenticator.Policy.NAME, policy =>
                  policy
                    .RequireAuthenticatedUser()
                    .Requirements.Add(new MfaVerifiedAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
