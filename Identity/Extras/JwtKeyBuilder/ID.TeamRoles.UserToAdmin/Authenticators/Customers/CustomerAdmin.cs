...
/// <summary>
/// Only a Customer Team Administrator shall pass!
/// </summary>
public static class CustomerAdminAuthenticator
{
    internal protected class AuthHandler : IAuthHandler
    {
        /// <summary>
        /// 
        /// </summary>
    ...
    {
        public const string NAME = $"{nameof(CustomerAdminAuthenticator)}.{nameof(Policy)}";
...
public static class CustomerAdminAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddCustomerAdminAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, CustomerAdminAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(CustomerAdminAuthenticator.Policy.NAME, policy =>
                  policy
                  .RequireAuthenticatedUser()
                  .Requirements.Add(new CustomerAdminAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
