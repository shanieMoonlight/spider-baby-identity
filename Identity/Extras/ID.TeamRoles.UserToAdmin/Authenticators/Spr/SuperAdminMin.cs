...
/// <summary>
/// Only a Super Team, Super Team or Super team at Mgr or higher shall pass!
/// </summary>
public static class SuperAdminMinimumAuthenticator
{
    /// <summary>
    /// <inheritdoc cref="SuperAdminMinimumAuthenticator"/>
    /// </summary>
    protected internal class AuthHandler : IAuthHandler
    {
        ...
        public bool IsAuthorized(HttpContext context) =>
            context.IsInSuperTeam() && context.IsAdminMin();
    ...
    {
        public const string NAME = $"{nameof(SuperAdminMinimumAuthenticator)}.{nameof(Policy)}";
...
public static class SuperAdminMinimumAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddSuperAdminMinimumAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, SuperAdminMinimumAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(SuperAdminMinimumAuthenticator.Policy.NAME, policy =>
                  policy
                  .RequireAuthenticatedUser()
                  .Requirements.Add(new SuperAdminMinimumAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
