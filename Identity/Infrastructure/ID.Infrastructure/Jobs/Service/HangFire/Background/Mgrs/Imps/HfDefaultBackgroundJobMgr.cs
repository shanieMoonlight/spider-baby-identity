...
/// <summary>
/// Implementation of the background job manager that uses the Default Queue for Hangfire integration.
...
internal class HfDefaultBackgroundJobMgr(IHangfireInstanceProvider instanceProvider)
    : AHfBackgroundJobMgr(
        instanceProvider,
        IdInfrastructureConstants.Jobs.Queues.Default),
    IHfDefaultBackgroundJobMgr
{ }
