...
/// </summary>
public static class CustomerAdminMinimumAuthenticator
{
    /// <summary>
    /// <inheritdoc cref="CustomerAdminMinimumAuthenticator"/>
    /// </summary>
    protected internal class AuthHandler : IAuthHandler
    {
        ...
        public bool IsAuthorized(HttpContext context) =>
            ...
            ||
            (context.IsInCustomerTeam() && context.IsAdminMin());
    ...
    {
        public const string NAME = $"{nameof(CustomerAdminMinimumAuthenticator)}.{nameof(Policy)}";
...
public static class CustomerAdminMinimumAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddCustomerAdminMinimumAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, CustomerAdminMinimumAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(CustomerAdminMinimumAuthenticator.Policy.NAME, policy =>
                  policy
                  .RequireAuthenticatedUser()
                  .Requirements.Add(new CustomerAdminMinimumAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
