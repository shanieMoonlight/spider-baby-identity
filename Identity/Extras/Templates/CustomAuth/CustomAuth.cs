using ID.Application.Filters.Abstractions;
...
public static class $safeitemname$Authenticator
{
    /// <summary>
    /// Only the Authorized Users shall pass!
    /// </summary>
    private class AuthHandler : IAuthHandler
    {
        /// <summary>
    ...
    {
        public const string NAME = $"{nameof($safeitemname$Authenticator)}.{nameof(Policy)}";
...
public static class $safeitemname$AuthenticatorPolicySetupExtensions
{
    public static IServiceCollection Add$safeitemname$AuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, $safeitemname$Authenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy($safeitemname$Authenticator.Policy.NAME, policy =>
                  policy
                    .RequireAuthenticatedUser()
                    .Requirements.Add(new $safeitemname$Authenticator.Policy.Requirement()))
        );
    }
}//Cls
