...
public static class MntcLeaderAuthenticator
{
    /// <summary>
    ...
    {
        public const string NAME = $"{nameof(MntcLeaderAuthenticator)}.{nameof(Policy)}";
...
public static class MntcLeaderAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddMntcLeaderAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, MntcLeaderAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(MntcLeaderAuthenticator.Policy.NAME, policy =>
                  policy
                    .RequireAuthenticatedUser()
                    .Requirements.Add(new MntcLeaderAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
