...
/// </summary>
public static class SuperManagerAuthenticator
{
    ...
    {
        public const string NAME = $"{nameof(SuperManagerAuthenticator)}.{nameof(Policy)}";
...
public static class SuperManagerAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddSuperManagerAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, SuperManagerAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(SuperManagerAuthenticator.Policy.NAME, policy =>
                  policy
                  .RequireAuthenticatedUser()
                  .Requirements.Add(new SuperManagerAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
