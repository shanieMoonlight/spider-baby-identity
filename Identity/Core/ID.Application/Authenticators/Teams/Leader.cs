...
/// <summary>
/// Only a Team Leader shall pass!
/// </summary>
public static class LeaderAuthenticator
{
    ...
    {
        public const string NAME = $"{nameof(LeaderAuthenticator)}.{nameof(Policy)}";
...
public static class LeaderAuthenticatorPolicySetupExtensions
{
    public static IServiceCollection AddLeaderAuthenticatorPolicy(this IServiceCollection services)
    {
        services.AddSingleton<IAuthorizationHandler, LeaderAuthenticator.Policy.Handler>();
        return services.AddAuthorization(options =>
              options.AddPolicy(LeaderAuthenticator.Policy.NAME, policy =>
                  policy
                  .RequireAuthenticatedUser()
                  .Requirements.Add(new LeaderAuthenticator.Policy.Requirement()))
        );
    }
}//Cls
