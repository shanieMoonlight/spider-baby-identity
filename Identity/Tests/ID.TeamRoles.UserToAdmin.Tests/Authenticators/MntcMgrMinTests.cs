...
public class MntcMgrMinTests
{
    ...
    private static async Task TestShouldPassClaims(List<Claim> claims)
    {
        ...
        var authHandler = new MntcManagerMinimumAuthenticator.AuthHandler();
        ...
        var resourceFilter = new MntcManagerMinimumAuthenticator.ResourceFilter();

        var actionContext = ContextProvider.GetActionExecutingContext(httpContext);
        var actionFilter = new MntcManagerMinimumAuthenticator.ActionFilter();
